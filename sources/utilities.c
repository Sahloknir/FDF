...
/*   Updated: 2018/04/20 14:56:12 by axbal            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (data->c_y1 <= data->range / 500)
		data->c_y1 = 1;
	else if (data->c_y1 < data->range / 50)
		data->c_y1 = 2;
	else if (data->c_y1 < data->range / 20)
		data->c_y1 = 3;
...
{
	if (data->c_y2 <= data->range / 500)
		data->c_y2 = 1;
	else if (data->c_y2 < data->range / 50)
		data->c_y2 = 2;
	else if (data->c_y2 < data->range / 20)
		data->c_y2 = 3;
