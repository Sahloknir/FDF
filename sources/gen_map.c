...
/*   Updated: 2018/04/21 16:21:39 by axbal            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	size_map(t_data *data)
{
	...
	if (data->gap_y <= 0)
		data->gap_y = 1;
	set_win_size(data);
	while ((data->win_w > 2000 || data->win_h > 2000) && data->gap_x > 1)
	{
		data->gap_x--;
		data->gap_y = data->gap_x / 5;
		if (data->gap_y <= 0)
	...
	if (data->win_w > 2000 || data->win_h > 2000)
	{
